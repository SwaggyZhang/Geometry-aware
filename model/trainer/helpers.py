...
from model.models.feat_concat import FEATCONCAT
...
def get_dataloader(args):
    ...
    elif args.dataset == 'OOS':
        from model.dataloader.SNIPS import OOS as Dataset
    else:
    ...
    train_sampler = CategoriesSampler(trainset.label_ind,
                                      num_episodes,
    ...
    val_sampler = CategoriesSampler(valset.label_ind,
    ...
    test_sampler = CategoriesSampler(testset.label_ind,
...
def prepare_model(args):
    ...
    if args.init_weights is not None:
        model_dict = model.state_dict()  # structure name and parameters of the network
