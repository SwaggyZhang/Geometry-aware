...
class Embedding(nn.Module):
    ...
    def __init__(self, word_vec_mat, max_length, word_embedding_dim=50, pos_embedding_dim=5):
        ...
        self.word_embedding = nn.Embedding(word_vec_mat.shape[0], self.word_embedding_dim, padding_idx=word_vec_mat.shape[0] - 1)  # (size of dictionary of embeddings, embedding dim, pads the output with the embedding vector at padding_idx)
