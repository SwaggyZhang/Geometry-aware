...
def postprocess_args(args):
    ...
    args.save_path = os.path.join(args.save_dir, save_path1, save_path2).replace('\\','/')
...
def get_command_line_parser():
    ...
    parser.add_argument('--dataset', type=str, default='OOS',
                        choices=['MiniImageNet', 'TieredImageNet', 'CUB', 'OOS'])
    ...
    # parser.add_argument('--option', type=str, default='add', choices=['concat, add'])  # option to label and data
    parser.add_argument('--alpha', type=float, help='the weight of proto', default=0.7)
